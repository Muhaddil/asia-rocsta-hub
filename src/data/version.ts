...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      {
        es: "Se han arreglado ciertos bugs con los manuales.",
        en: "Fixed certain bugs with the manuals.",
      },
      {
        es: "Se ha actualizado la versión del proyecto a la 1.5.2",
        en: "Bump project version to 1.5.2",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        es: "Se ha mejorado el sistema de los manuales.",
        en: "Improved the manuals system.",
      },
      {
        es: "Se han actualizado diversas dependencias de la web",
        en: "Updated several web dependencies",
      ...
      {
        es: "Se ha actualizado la versión del proyecto a la 1.5.0",
        en: "Bump project version to 1.5.0",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        es: "Se ha arreglado un error con el schema de la página de acerca de.",
        en: "Fixed an error with the about page schema.",
      },
      {
        es: "Se ha actualizado la versión del proyecto a la 1.4.62",
        en: "Bump project version to 1.4.62",
      },
    ],
  },
  {
    ...
    changes: [
      {
        es: "Se ha arreglado un error con la indexación.",
        en: "Fixed an error with indexing.",
      },
      {
        es: "Se ha actualizado la versión del proyecto a la 1.4.61",
        en: "Bump project version to 1.4.61",
      },
    ],
  },
  {
