    ...
    <PageShell>
      ...
      <section className="mb-12">
        <div className="mb-6 flex items-center justify-between">
          ...
          <Link to="/parts" className="text-sm font-bold text-rocsta-green hover:underline">
      ...
      <section className="mb-12">
        <div className="mb-6 flex items-center justify-between">
          ...
          <Link to="/guides" className="text-sm font-bold text-rocsta-green hover:underline">
            {t("home.guides.all")}
          </Link>
        </div>
