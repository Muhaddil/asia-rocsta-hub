...
//#endregion
//#region src/routes/manuals.tsx
var $$splitComponentImporter = () => import("./manuals-B9oXAYHZ.js");
var manualsSearchSchema = z.object({
...
var Route = createFileRoute("/manuals")({
	...
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Descarga manuales de servicio oficiales del chasis, motores diésel Mazda R2 y gasolina F8, esquemas de cables eléctricos y fichas técnicas reducidas."
			},
			{
				property: "og:title",
				content: "Manuales Técnicos — Asia Rocsta Archive"
			},
			{
				property: "og:url",
				content: "/manuals"
...
//#endregion
export { manuals as n, Route as t };
