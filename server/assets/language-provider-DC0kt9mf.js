...
//#region src/components/language-provider.tsx
...
var UI_TRANSLATIONS = {
	...
	"cat.engine": {
		es: "Motor y refrigeración",
		en: "Engine & Cooling"
	},
	"cat.transmission": {
		es: "Transmisión y 4x4",
		en: "Transmission & 4WD"
	},
	"cat.suspension": {
	...
	"cat.tires": {
		es: "Neumáticos y ruedas",
		en: "Tires & Wheels"
	},
	"cat.body": {
		es: "Carrocería e interiores",
		en: "Body & Interiors"
	},
	"comm.contrib": {
		es: "Aportar Equivalencia",
		en: "Submit Equivalence"
	},
	"comm.part": {
		es: "Sugerir Nueva Pieza",
		en: "Suggest New Part"
	},
	"comm.guide": {
		es: "Proponer Nueva Guía",
		en: "Suggest New Guide"
	},
	"comm.problem": {
		es: "Reportar Avería",
		en: "Report an Issue"
	...
	"comm.bug": {
		es: "Reportar Error Web",
		en: "Report Website Bug"
	},
	"comm.partwrong": {
		es: "Corregir Pieza Errónea",
		en: "Fix Wrong Part Data"
	},
	"search.placeholder": {
		es: "Buscar piezas, OEM, guías...",
		en: "Search parts, OEM, guides..."
	},
	...
	"search.results": {
		es: "Resultados del Archivo",
		en: "Archive Results"
	},
	"search.noMatches": {
		es: "No se encontraron coincidencias para",
		en: "No matches found for"
	},
	"search.info": {
	...
	"home.title": {
		es: "La referencia técnica del",
		en: "The Technical Hub for the"
	},
	"home.noPopularParts": {
	...
	"home.stats.years": {
		es: "Años de producción",
		en: "Production Years"
	},
	"home.stats.engines": {
		es: "Motores documentados",
		en: "Documented Engines"
	},
	"home.stats.markets": {
	...
	"home.popular": {
		es: "Piezas populares y equivalencias",
		en: "Popular Parts & Swaps"
	},
	...
	"home.popular.verified": {
		es: "Verificado",
		en: "Verified"
	},
	"home.popular.requiresMod": {
		es: "Requiere mod.",
		en: "Requires mod"
	},
	"home.guides.recent": {
	...
	"home.guides.read": {
		es: "Ver paso a paso →",
		en: "View step-by-step →"
	},
	"home.guides.contribs": {
		es: "contribuciones",
		en: "contributions"
	},
	"home.issues.timeline": {
		es: "Registro de problemas comunes",
		en: "Common Issues Timeline"
	},
	"home.issues.desc": {
	...
	"home.issues.viewAll": {
		es: "Ver base de problemas →",
		en: "View issues database →"
	},
	"parts.title": {
		es: "Catálogo de piezas y repuestos",
		en: "Component & Spare Parts Catalog"
	},
	"parts.desc": {
	...
	"parts.filter.allCategories": {
		es: "Cualquier categoría",
		en: "All Categories"
	},
	"parts.filter.allEngines": {
		es: "Cualquier motor",
		en: "All Engines"
	},
	"parts.filter.engineGas": {
		es: "Mazda F8 Gasolina",
		en: "Mazda F8 Petrol"
	},
	"parts.filter.engineDiesel": {
		es: "Mazda R2 Diésel",
		en: "Mazda R2 Diesel"
	},
	"parts.filter.engineBoth": {
		es: "Ambos motores",
		en: "Both Engines"
	},
	"parts.filter.allStatus": {
		es: "Cualquier verificación",
		en: "All Verifications"
	},
	"parts.filter.statusVerified": {
		es: "Solo verificado",
		en: "Verified Fit"
	},
	"parts.filter.statusMod": {
		es: "Requiere modificación",
		en: "Requires Modification"
	},
	"parts.filter.statusUnverified": {
		es: "Sin verificar",
		en: "Unverified / Unknown"
	},
	"parts.results.count": {
		es: "piezas coinciden",
		en: "parts match"
	...
	"parts.table.name": {
		es: "Repuesto / Sistema",
		en: "Spare Part / System"
	},
	"parts.table.oem": {
		es: "OEM Asia Motors",
		en: "Asia Motors OEM"
	},
	"parts.table.crossover": {
		es: "Cruces de Marcas",
		en: "Brand Crossovers"
	},
	"parts.table.engine": {
	...
	"parts.dialog.title": {
		es: "Ficha técnica del repuesto",
		en: "Spare Part Technical Sheet"
	},
	"parts.dialog.category": {
		es: "Categoría del sistema",
		en: "System Category"
	},
	"parts.dialog.oem": {
		es: "Referencia OEM original",
		en: "Original OEM Reference"
	},
	...
	"parts.dialog.notes": {
		es: "Notas de montaje y consejos",
		en: "Fitting Notes & Advice"
	},
	...
	"comp.title": {
		es: "Buscador de equivalencias y swaps",
		en: "Crossover Swaps & Fitting Index"
	},
	"comp.desc": {
	...
	"comp.filter.allDonors": {
		es: "Cualquier donante",
		en: "All Donors"
	},
	"comp.filter.allFits": {
		es: "Cualquier ajuste",
	...
	"comp.fit.direct": {
		es: "Directo (Plug & Play)",
		en: "Direct Fit (Plug & Play)"
	},
	"comp.fit.mod": {
		es: "Requiere adaptación",
		en: "Requires Adaptation"
	},
	"comp.filter.allDifficulty": {
		es: "Cualquier dificultad",
		en: "All Difficulties"
	},
	"comp.diff.easy": {
		es: "Fácil",
	...
	"comp.results.count": {
		es: "compatibilidades encontradas",
		en: "compatibilities found"
	},
	"comp.table.part": {
		es: "Pieza Rocsta",
		en: "Rocsta Part"
	...
	"comp.table.confirmations": {
		es: "Confirmaciones",
		en: "Confirmations"
	},
	"comp.table.confirmed": {
		es: "usuarios confirman",
		en: "users confirmed"
	},
	"comp.noResults": {
		es: "Sin compatibilidades",
		en: "No crossovers found"
	},
	"comp.noResultsDesc": {
	...
	"guides.filter.allLevels": {
		es: "Cualquier nivel",
		en: "All Skill Levels"
	},
	"guides.level.beginner": {
		es: "Principiante",
		en: "Beginner"
	},
	"guides.level.intermediate": {
		es: "Intermedio",
		en: "Intermediate"
	},
	"guides.level.advanced": {
		es: "Avanzado",
		en: "Advanced"
	},
	"guides.results.count": {
		es: "guías disponibles",
		en: "guides available"
	},
	"guides.card.time": {
		es: "Duración",
	...
	"guides.card.difficulty": {
		es: "Dificultad",
		en: "Difficulty"
	},
	"guides.card.view": {
		es: "Ver procedimiento paso a paso",
		en: "View step-by-step guide"
	},
	"guides.dialog.tools": {
	...
	"problems.filter.allSeverity": {
		es: "Cualquier severidad",
		en: "All Severities"
	},
	"problems.severity.critical": {
		es: "Crítico (Reparar ya)",
		en: "Critical (Fix ASAP)"
	},
	"problems.severity.warn": {
		es: "Advertencia (Atención)",
		en: "Warning (Pay Attention)"
	},
	"problems.severity.info": {
		es: "Información (Molesto)",
		en: "Info (Annoyance)"
	},
	"problems.results.count": {
		es: "averías registradas",
		en: "issues registered"
	},
	"problems.card.miles": {
		es: "Kilometraje típico",
		en: "Typical Mileage"
	},
	"problems.card.cost": {
		es: "Coste piezas",
	...
	"problems.card.reports": {
		es: "casos en el club",
		en: "club reports"
	},
	"problems.card.diagnose": {
		es: "Ver ficha de diagnóstico",
		en: "View Diagnostic Sheet"
	},
	"problems.dialog.symptoms": {
		es: "Síntomas de alerta",
		en: "Warning Symptoms"
	},
	"problems.dialog.causes": {
		es: "Causas principales",
		en: "Root Causes"
	},
	"problems.dialog.fix": {
		es: "Procedimiento de reparación",
		en: "Repair Procedure"
	},
	"problems.noResults": {
		es: "Sin averías",
	...
	"manuals.filter.allTypes": {
		es: "Cualquier tipo",
		en: "All Types"
	},
	"manuals.type.workshop": {
		es: "Manuales de Taller",
		en: "Workshop Manuals"
	},
	"manuals.type.electrical": {
		es: "Esquemas Eléctricos",
		en: "Wiring Schematics"
	},
	"manuals.type.catalog": {
		es: "Catálogos de Piezas",
		en: "Parts Microfiches"
	},
	"manuals.type.datasheet": {
		es: "Fichas Técnicas ITV",
		en: "Homologations"
	},
	"manuals.filter.allLanguages": {
		es: "Cualquier idioma",
		en: "All Languages"
	},
	"manuals.lang.es": {
	...
	"manuals.results.count": {
		es: "documentos disponibles",
		en: "documents available"
	},
	"manuals.card.download": {
		es: "Descargar",
		en: "Download"
	},
	"manuals.noResults": {
	...
	"comm.stats.parts": {
		es: "Piezas Documentadas",
		en: "Parts Catalogued"
	},
	"comm.stats.swaps": {
		es: "Equivalencias Verificadas",
		en: "Verified Swaps"
	},
	"comm.stats.guides": {
		es: "Guías Técnicas",
	...
	"comm.stats.logs": {
		es: "Aportaciones Globales",
		en: "Total Contributions"
	},
	"comm.form.title": {
		es: "Envía tu aportación",
		en: "Submit Your Contribution"
	},
	"comm.form.desc": {
	...
	"comm.form.photo.year": {
		es: "Año del vehículo",
		en: "Vehicle year"
	},
	"comm.form.photo.yearPlaceholder": {
		es: "Ej: 1995",
		en: "e.g. 1995"
	},
	"comm.form.photo.motor": {
		es: "Motor",
		en: "Engine"
	},
	"comm.form.photo.country": {
		es: "País",
		en: "Country"
	},
	"comm.form.photo.countryPlaceholder": {
		es: "Ej: 🇪🇸 España",
		en: "e.g. 🇪🇸 Spain"
	},
	"comm.form.photo.photo": {
		es: "Seleccionar foto",
		en: "Select photo"
	},
	"comm.form.submitted": {
		es: "¡Aportación registrada!",
		en: "Contribution Registered!"
	},
	...
	"comm.form.comp.title": {
		es: "Componente Rocsta",
		en: "Rocsta Component"
	},
	...
	"comm.form.comp.donorRef": {
		es: "Referencia OEM donante",
		en: "Donor OEM Ref"
	},
	"comm.form.comp.donorRefPlaceholder": {
		es: "Ej. B6S7-13-Z40",
		en: "e.g. B6S7-13-Z40"
	},
	"comm.form.comp.swapType": {
		es: "Tipo de montaje",
		en: "Swap Type"
	},
	"comm.form.comp.swapType.directo": {
		es: "Directo (plug & play)",
		en: "Direct (plug & play)"
	},
	...
	"comm.form.comp.motor": {
		es: "Motor compatible",
		en: "Compatible Engine"
	},
	"comm.form.comp.notes": {
		es: "Notas de montaje",
		en: "Fitting Notes"
	},
	...
	"comm.form.part.oemPlaceholder": {
		es: "Ej. 0 445 110 217",
		en: "e.g. 0 445 110 217"
	},
	"comm.form.part.category": {
		es: "Categoría",
		en: "Category"
	},
	"comm.form.part.motor": {
		es: "Motor",
		en: "Engine"
	},
	"comm.form.part.description": {
		es: "Descripción",
		en: "Description"
	},
	...
	"comm.form.guide.title": {
		es: "Título del brico / manual",
		en: "Repair / Manual Title"
	},
	"comm.form.guide.titlePlaceholder": {
		es: "Ej. Tensado del cable de freno de mano",
		en: "e.g. Handbrake cable tightening"
	},
	"comm.form.guide.category": {
		es: "Tipo de guía",
		en: "Guide Type"
	},
	"comm.form.guide.tools": {
		es: "Herramientas necesarias",
		en: "Required Tools"
	},
	...
	"comm.form.guide.content": {
		es: "Contenido paso a paso",
		en: "Step-by-Step Content"
	},
	...
	"comm.form.problem.title": {
		es: "Descripción corta del fallo",
		en: "Short Issue Description"
	},
	"comm.form.problem.titlePlaceholder": {
		es: "Ej. Rotura del cable de embrague",
		en: "e.g. Snapped clutch cable"
	},
	"comm.form.problem.motor": {
		es: "Motor afectado",
		en: "Affected Engine"
	},
	...
	"comm.form.problem.mileagePlaceholder": {
		es: "Ej. 120000",
		en: "e.g. 120000"
	},
	"comm.form.problem.symptoms": {
		es: "Síntomas",
		en: "Symptoms"
	},
	...
	"comm.form.problem.solution": {
		es: "Solución aplicada",
		en: "Applied Solution"
	},
	...
	"comm.form.bug.urlPlaceholder": {
		es: "Ej. /parts/p-001",
		en: "e.g. /parts/p-001"
	},
	"comm.form.bug.browser": {
		es: "Navegador / SO",
		en: "Browser / OS"
	},
	...
	"comm.form.partwrong.title": {
		es: "Pieza con datos incorrectos",
		en: "Part with Wrong Data"
	},
	...
	"comm.form.partwrong.correction": {
		es: "Corrección propuesta",
	...
	"comm.form.partwrong.source": {
		es: "Fuente de verificación",
		en: "Verification Source"
	},
	...
	"comm.leaders.title": {
		es: "Top Colaboradores",
		en: "Top Tech Contributors"
	},
	"comm.leaders.desc": {
	...
	"header.mobileProblems": {
		es: "Problemas",
		en: "Problems"
	},
	"header.mobileManuals": {
		es: "Manuales",
		en: "Manuals"
	},
	"header.mobileCommunity": {
		es: "Comunidad",
		en: "Community"
	},
	"footer.tagline": {
	...
	"parts.filter.allEnginesLabel": {
		es: "Todos los motores",
		en: "All Engines"
	},
	"parts.filter.allStatusLabel": {
		es: "Cualquier estado",
		en: "All Status"
	},
	"parts.filter.verified100": {
		es: "Verificado al 100%",
		en: "100% Verified"
	},
	"parts.filter.requiresMod": {
		es: "Requiere adaptación",
		en: "Requires Adaptation"
	},
	"parts.filter.unverified": {
		es: "Sin verificar",
		en: "Unverified"
	},
	"parts.filter.engineF8": {
		es: "Gasolina SOHC 1.8 (Mazda F8)",
		en: "Petrol SOHC 1.8 (Mazda F8)"
	},
	"parts.filter.engineR2": {
		es: "Diésel 2.2 / Turbo (Mazda R2)",
		en: "Diesel 2.2 / Turbo (Mazda R2)"
	},
	"parts.filter.engineBothOption": {
		es: "Común a ambos motores",
		en: "Common to both engines"
	},
	...
	"parts.engineCompat": {
		es: "Compatibilidad Motor",
		en: "Engine Compatibility"
	},
	"parts.crossRefs": {
		es: "Referencias cruzadas aftermarket",
		en: "Aftermarket Cross References"
	},
	"parts.equivVehicles": {
		es: "Vehículos equivalentes donantes",
		en: "Equivalent Donor Vehicles"
	},
	"parts.installNotes": {
	...
	"parts.classicParts": {
		es: "Recambios mecánicos clásicos",
		en: "Classic Mechanical Spares"
	},
	"parts.badge.verified": {
		es: "Verificado",
		en: "Verified"
	},
	"parts.badge.mod": {
	...
	"parts.badge.engineF8": {
		es: "Mazda F8 1.8 Gasolina",
		en: "Mazda F8 1.8 Petrol"
	},
	"parts.badge.engineR2": {
		es: "Mazda R2 2.2 Diésel",
		en: "Mazda R2 2.2 Diesel"
	},
	"parts.badge.engineBoth": {
		es: "Común (Ambos Motores)",
		en: "Common (Both Engines)"
	},
	"comp.searchCompatPlaceholder": {
		es: "Buscar pieza Rocsta, donante, referencia...",
		en: "Search Rocsta part, donor, reference..."
	},
	"comp.filter.allFitTypes": {
		es: "Cualquier tipo de ajuste",
		en: "All Fit Types"
	},
	"comp.fitDirectOption": {
		es: "Ajuste directo (Plug & Play)",
		en: "Direct Fit (Plug & Play)"
	},
	"comp.fitAdaptOption": {
	...
	"comp.filter.allDifficultyLabel": {
		es: "Cualquier dificultad",
		en: "All Difficulties"
	},
	"comp.diffEasyOption": {
	...
	"comp.table.confirmedCount": {
		es: "usuarios",
		en: "users"
	},
	"comp.swapVerified": {
		es: "Swap Verificado por la Comunidad",
		en: "Community-Verified Swap"
	},
	"comp.swapCaution": {
		es: "Requiere Precaución / Adaptable",
		en: "Requires Caution / Adaptable"
	},
	"comp.confirmedBy": {
	...
	"comp.dialog.donorVehicle": {
		es: "Vehículo Donante",
		en: "Donor Vehicle"
	},
	"comp.dialog.donorRef": {
		es: "Referencia Donante",
		en: "Donor Reference"
	},
	"comp.dialog.fitType": {
	...
	"comp.dialog.difficultyLabel": {
		es: "Dificultad de montaje",
		en: "Assembly Difficulty"
	},
	"comp.dialog.directFit": {
		es: "Directo (Plug & Play)",
		en: "Direct Fit (Plug & Play)"
	},
	"comp.dialog.requiresAdapt": {
		es: "Requiere Adaptación",
		en: "Requires Adaptation"
	},
	"comp.confirm": {
	...
	"comp.confirmDialog.title": {
		es: "¿Confirmar equivalencia?",
		en: "Confirm crossover?"
	},
	...
	"comp.confirmDialog.yes": {
		es: "Sí, confirmar",
		en: "Yes, confirm"
	},
	"comp.confirmDialog.no": {
		es: "Cancelar",
		en: "Cancel"
	},
	...
	"guides.filter.allMotorsLabel": {
		es: "Cualquier motor",
		en: "All Engines"
	},
	"guides.filter.motorF8": {
		es: "Gasolina 1.8 (F8)",
		en: "Petrol 1.8 (F8)"
	},
	"guides.filter.motorR2": {
		es: "Diésel 2.2 / Turbo (R2)",
		en: "Diesel 2.2 / Turbo (R2)"
	},
	"guides.filter.motorBoth": {
		es: "Común a ambos",
		en: "Common to both"
	},
	"guides.filter.allLevelsLabel": {
		es: "Cualquier dificultad",
		en: "All Skill Levels"
	},
	"guides.filter.levelBeginner": {
		es: "Principiante",
		en: "Beginner"
	},
	"guides.filter.levelIntermediate": {
		es: "Intermedio",
		en: "Intermediate"
	},
	"guides.filter.levelAdvanced": {
		es: "Avanzado",
		en: "Advanced"
	},
	"guides.resultsFound": {
	...
	"problems.filter.allSeverityLabel": {
		es: "Cualquier severidad",
		en: "All Severities"
	},
	...
	"problems.filter.allMotorsLabel": {
		es: "Cualquier motor",
		en: "All Engines"
	},
	"problems.filter.motorF8": {
		es: "Gasolina 1.8 (F8)",
		en: "Petrol 1.8 (F8)"
	},
	"problems.filter.motorR2": {
		es: "Diésel 2.2 (R2)",
		en: "Diesel 2.2 (R2)"
	},
	"problems.filter.motorBoth": {
		es: "Común a ambos",
		en: "Common to both"
	},
	...
	"problems.typicalMileage": {
		es: "Aparición común:",
		en: "Typical onset:"
	},
	"problems.symptomLabel": {
		es: "Síntoma:",
		en: "Symptom:"
	},
	"problems.reportsCount": {
		es: "casos",
		en: "cases"
	},
	"problems.dialog.cost": {
		es: "Coste estimado de piezas",
		en: "Estimated Parts Cost"
	},
	"problems.dialog.difficulty": {
		es: "Dificultad de la reparación",
	...
	"problems.dialog.symptomsTitle": {
		es: "Síntomas del fallo",
		en: "Fault Symptoms"
	},
	...
	"problems.dialog.solutionTitle": {
		es: "Procedimiento de solución",
		en: "Solution Procedure"
	},
	"problems.registryLabel": {
		es: "Registro Técnico Rocsta",
		en: "Rocsta Technical Registry"
	},
	"manuals.searchManualsPlaceholder": {
		es: "Buscar por título de manual, año...",
		en: "Search by manual title, year..."
	},
	"manuals.filter.allTypesLabel": {
		es: "Cualquier tipo",
		en: "All Types"
	},
	"manuals.labelWorkshop": {
		es: "Manuales de Taller",
		en: "Workshop Manuals"
	},
	"manuals.labelElectrical": {
		es: "Esquemas Eléctricos",
		en: "Wiring Schematics"
	},
	"manuals.labelCatalog": {
		es: "Catálogos de Piezas",
		en: "Parts Catalogs"
	},
	"manuals.labelDatasheet": {
		es: "Fichas Técnicas ITV",
		en: "Homologation Sheets"
	},
	"manuals.filter.allLangs": {
		es: "Cualquier idioma",
		en: "All Languages"
	},
	"manuals.labelSpanish": {
		es: "Español 🇪🇸",
		en: "Spanish 🇪🇸"
	},
	"manuals.labelEnglish": {
		es: "Inglés 🇬🇧",
		en: "English 🇬🇧"
	},
	"manuals.labelKorean": {
	...
	"about.title": {
		es: "Acerca del Asia Rocsta",
		en: "About the Asia Rocsta"
	},
	"about.lead": {
	...
	"maint.gearbox": {
		es: "Aceite caja de cambios y transfer",
		en: "Gearbox & transfer oil"
	},
	"maint.diff": {
		es: "Aceite diferenciales delantero y trasero",
		en: "Front & rear diff oil"
	},
	"maint.grease": {
...
var LanguageProvider = ({ children }) => {
	...
	const t = (key, replacements) => {
		...
		if (replacements) Object.entries(replacements).forEach(([k, v]) => {
