...
var guides = [
	{
		...
		level: "Intermedio",
		time: "2.5 h",
		image: "/assets/guide-timing-belt-Bf-NaVtQ.jpg",
		motor: "R2",
		category: "engine",
		tools: [
			{
			...
			{
				es: "Llave dinamométrica (20-120 Nm)",
				en: "Torque wrench (20-120 Nm)"
			},
			{
		...
		steps: [
			...
			{
				title: {
					es: "Paso 6: Reensamblado completo",
					en: "Step 6: Complete reassembly"
				},
				content: {
	...
	},
	{
		...
		level: "Intermedio",
		time: "1.0 h",
		image: "/assets/guide-4wd-hubs-KuW_HGEQ.jpg",
		motor: "ambos",
		...
		tools: [
			...
			{
				es: "Llave de vaso o estrella de 12 mm",
				en: "12 mm socket or wrench"
			},
			{
			...
			{
				es: "Desengrasante / Limpiador de frenos",
				en: "Degreaser / Brake cleaner"
			},
			{
				es: "Grasa de litio EP2 de alta calidad",
				en: "High-quality EP2 lithium grease"
			},
			{
				es: "Trapos limpios",
				en: "Clean rags"
		...
		steps: [
			{
				title: {
					es: "Paso 1: Desmontaje de la tapa del cubo",
					en: "Step 1: Remove the hub cover"
				},
				content: {
			...
			{
				title: {
					es: "Paso 4: Inspección de desgaste",
					en: "Step 4: Wear inspection"
				},
				content: {
			...
			{
				title: {
					es: "Paso 6: Ajuste final y prueba",
					en: "Step 6: Final adjustment and test"
				},
				content: {
	...
	},
	{
		...
		tools: [
			{
				es: "Llave fija o de estrella de 12 mm",
				en: "12 mm open-end or box wrench"
			},
			{
				es: "Cepillo metálico pequeño",
				en: "Small wire brush"
			},
			{
		...
		steps: [
			{
				title: {
					es: "Paso 1: Localización de la EGR",
					en: "Step 1: Locate the EGR valve"
				},
				content: {
			...
			{
				title: {
					es: "Paso 2: Desmontaje de la válvula",
					en: "Step 2: Remove the valve"
				},
				content: {
			...
			{
				title: {
					es: "Paso 3: Limpieza de la carbonilla",
					en: "Step 3: Clean the carbon deposits"
				},
				content: {
